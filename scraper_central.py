...
def main():
    ...
    with open(csv_file, 'a', newline='') as file:
        ...
        for index, (lat, lon) in enumerate(tile_centers):
            ...
            img_array = np.frombuffer(png, dtype=np.uint8)
            ...
            file.flush()  # Ensure real-time CSV writing

    driver.quit()
    print(f"\n✅ Scraping done at {timestamp} without saving screenshots.")
